...
p2 <- ggplot(Farm_dfB02) +
  ...
  theme(axis.text.y = element_text(size = 12,colour = "black"),
        ...
        axis.ticks.x=element_blank(),
        plot.title=element_text(size = 15, face = "bold"))
p3 <- ggplot(Farm_dfB03) +
  geom_line( aes(x=Date, y=stored_manure),color="blue",size=2) +
  scale_x_date(date_breaks = "1 month", date_labels =  "%b %Y") +
  scale_y_continuous(labels =function(x) format(x, scientific = FALSE))+
  geom_point(data=subset(Farm_dfB03,Farm_dfB03$Date==c("2019-04-01")),aes(Date,stored_manure),shape=1,size=8,col="red",stroke=3) +
  geom_point(data=subset(Farm_dfB03,Farm_dfB03$Date==c("2019-07-04")),aes(Date,stored_manure),shape=1,size=8,col="red",stroke=3) +
  geom_point(data=subset(Farm_dfB03,Farm_dfB03$Date==c("2019-10-11")),aes(Date,stored_manure),shape=1,size=8,col="red",stroke=3) +
  geom_point(data=subset(Farm_dfB03,Farm_dfB03$Date==c("2019-07-12")),aes(Date,stored_manure),shape=1,size=8,col="green",stroke=3) +
  labs(y = 'Stored Manure (kg)')+
  ggtitle("Monkton Rd Farm")+
...
#######fractions
mean(Farm_dfB01$Nmin_frac)*10^4
mean(Farm_dfB01$Pmin_frac)*10^4
mean(Farm_dfB01$Norg_frac)*10^4
mean(Farm_dfB01$Porg_frac)*10^4
