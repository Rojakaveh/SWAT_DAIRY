    ...
    if (k+1 <= nrow(Date)){
      ...
      if (Animal_df$TotalNP_barn[k]>= Max_capacity){
        ...
        Animal_df$TotalNP_barn[k]=Max_capacity
          ...
          assign(nam2,data.frame(Barn_number=mgt_datafram$Barn_number[mgt_datafram$HRU_number==i][1],
                     ...
                     FERT_APPLIED=(Max_capacity/FARMarea)*mgt_datafram$Area_ha[mgt_datafram$HRU_number==i][1]))
